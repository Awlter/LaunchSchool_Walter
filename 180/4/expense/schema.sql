...
--
-- Name: expenses; Type: TABLE; Schema: public; Owner: wangxuefei
--
...
ALTER TABLE expenses OWNER TO wangxuefei;

--
-- Name: expenses_id_seq; Type: SEQUENCE; Schema: public; Owner: wangxuefei
--
...
ALTER TABLE expenses_id_seq OWNER TO wangxuefei;

--
-- Name: expenses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: wangxuefei
--
...
--
-- Name: expenses id; Type: DEFAULT; Schema: public; Owner: wangxuefei
--
...
--
-- Data for Name: expenses; Type: TABLE DATA; Schema: public; Owner: wangxuefei
--
