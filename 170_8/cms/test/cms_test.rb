...
class CmsTest < Minitest::Test
  ...
  def test_create_new_document
    post "/create", { filename: "test_file.txt" }, admin_session
    assert_equal 302, last_response.status
    assert_equal "test_file.txt was created.", session[:message]
  ...
  def test_create_new_document_signed_out
    post '/create', {filename: "test_file.txt"}
  ...
  def test_deleting_document
    ...
    assert_equal 302, last_response.status
    assert_equal "test_file.txt was deleted.", session[:message]
  ...
  def test_signin_with_bad_credentials
    post '/users/signin', username: 'hehe', password: 'hehe'
    assert_equal 422, last_response.status
